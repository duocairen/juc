 ...
 * a {@link java.util.concurrency.ConcurrentSkipListMap}.  The elements of the set are kept
...
public class ConcurrentSkipListSet<E>
     ...
     */
    private final java.util.concurrency.ConcurrentNavigableMap<E,Object> m;
    ...
    public ConcurrentSkipListSet() {
        m = new java.util.concurrency.ConcurrentSkipListMap<E,Object>();
    }
    ...
    public ConcurrentSkipListSet(Comparator<? super E> comparator) {
        m = new java.util.concurrency.ConcurrentSkipListMap<E,Object>(comparator);
    }
    ...
    public ConcurrentSkipListSet(SortedSet<E> s) {
        m = new java.util.concurrency.ConcurrentSkipListMap<E,Object>(s.comparator());
        addAll(s);
    }
     ...
     * For use by submaps
     */
    ConcurrentSkipListSet(java.util.concurrency.ConcurrentNavigableMap<E,Object> m) {
        this.m = m;
    }
    ...
    public ConcurrentSkipListSet<E> clone() {
        try {
            ...
            clone.setMap(new java.util.concurrency.ConcurrentSkipListMap<E,Object>(m));
            return clone;
    ...
    public Spliterator<E> spliterator() {
        if (m instanceof java.util.concurrency.ConcurrentSkipListMap)
            return ((java.util.concurrency.ConcurrentSkipListMap<E,?>)m).keySpliterator();
        else
            return (Spliterator<E>)((java.util.concurrency.ConcurrentSkipListMap.SubMap<E,?>)m).keyIterator();
    }

    // Support for resetting map in clone
    private void setMap(java.util.concurrency.ConcurrentNavigableMap<E,Object> map) {
