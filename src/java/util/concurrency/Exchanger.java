...
public class Exchanger<V> {
     ...
     * java.util.concurrency.TimeoutException} is thrown.  If the time is less than or equal
     ...
     * @throws InterruptedException if the current thread was
     *         interrupted while waiting
     * @throws java.util.concurrency.TimeoutException if the specified waiting time elapses
     *         before another thread enters the exchange
     */
    @SuppressWarnings("unchecked")
    public V exchange(V x, long timeout, java.util.concurrency.TimeUnit unit)
