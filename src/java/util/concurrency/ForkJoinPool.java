...
/**
 * An {@link java.util.concurrency.ExecutorService} for running {@link java.util.concurrency.ForkJoinTask}s.
 * A {@code ForkJoinPool} provides the entry point for submissions
 * from non-{@code ForkJoinTask} clients, as well as management and
 * monitoring operations.
 *
 * <p>A {@code ForkJoinPool} differs from other kinds of {@link
 * java.util.concurrency.ExecutorService} mainly by virtue of employing
 ...
 *    <td> {@link #execute(java.util.concurrency.ForkJoinTask)}</td>
 *    <td> {@link java.util.concurrency.ForkJoinTask#fork}</td>
 *  </tr>
 *  <tr>
 *    <td> <b>Await and obtain result</b></td>
 *    <td> {@link #invoke(java.util.concurrency.ForkJoinTask)}</td>
 *    <td> {@link java.util.concurrency.ForkJoinTask#invoke}</td>
 *  </tr>
 *  <tr>
 *    <td> <b>Arrange exec and obtain Future</b></td>
 *    <td> {@link #submit(java.util.concurrency.ForkJoinTask)}</td>
 *    <td> {@link java.util.concurrency.ForkJoinTask#fork} (ForkJoinTasks <em>are</em> Futures)</td>
 *  </tr>
 * </table>
 *
 ...
 * <ul>
 * <li>{@code ForkJoinPool.common.parallelism}
 * - the parallelism level, a non-negative integer
 * <li>{@code ForkJoinPool.common.threadFactory}
 * - the class name of a {@link ForkJoinWorkerThreadFactory}
 * <li>{@code ForkJoinPool.common.exceptionHandler}
 ...
 * {@link java.util.concurrency.RejectedExecutionException}) only when the pool is shut down
 ...
 */
@sun.misc.Contended
public class ForkJoinPool extends java.util.concurrency.AbstractExecutorService {
    ...
    /**
     * Factory for creating new {@link java.util.concurrency.ForkJoinWorkerThread}s.
    ...
    public static interface ForkJoinWorkerThreadFactory {
         ...
         */
        public java.util.concurrency.ForkJoinWorkerThread newThread(ForkJoinPool pool);
    }
    ...
    static final class DefaultForkJoinWorkerThreadFactory
        ...
        public final java.util.concurrency.ForkJoinWorkerThread newThread(ForkJoinPool pool) {
            return new java.util.concurrency.ForkJoinWorkerThread(pool);
        }
    }
     ...
     */
    static final class EmptyTask extends java.util.concurrency.ForkJoinTask<Void> {
        private static final long serialVersionUID = -7721805057305804111L;
        EmptyTask() { status = java.util.concurrency.ForkJoinTask.NORMAL; } // force done
    ...
    static final class WorkQueue {
        ...
        java.util.concurrency.ForkJoinTask<?>[] array;   // the elements (initially unallocated)
        final ForkJoinPool pool;   // the containing pool (may be null)
        final java.util.concurrency.ForkJoinWorkerThread owner; // owning thread or null if shared
        volatile Thread parker;    // == owner during call to park; else null
        volatile java.util.concurrency.ForkJoinTask<?> currentJoin;  // task being joined in awaitJoin
        volatile java.util.concurrency.ForkJoinTask<?> currentSteal; // mainly used by helpStealer

        WorkQueue(ForkJoinPool pool, java.util.concurrency.ForkJoinWorkerThread owner) {
            this.pool = pool;
            this.owner = owner;
        ...
        final boolean isEmpty() {
            java.util.concurrency.ForkJoinTask<?>[] a; int n, m, s;
         ...
         * @throws java.util.concurrency.RejectedExecutionException if array cannot be resized
         */
        final void push(java.util.concurrency.ForkJoinTask<?> task) {
            java.util.concurrency.ForkJoinTask<?>[] a; ForkJoinPool p;
            int b = base, s = top, n;
         ...
         */
        final java.util.concurrency.ForkJoinTask<?>[] growArray() {
            java.util.concurrency.ForkJoinTask<?>[] oldA = array;
            int size = oldA != null ? oldA.length << 1 : INITIAL_QUEUE_CAPACITY;
            if (size > MAXIMUM_QUEUE_CAPACITY)
                throw new java.util.concurrency.RejectedExecutionException("Queue capacity exceeded");
            int oldMask, t, b;
            java.util.concurrency.ForkJoinTask<?>[] a = array = new java.util.concurrency.ForkJoinTask<?>[size];
            if (oldA != null && (oldMask = oldA.length - 1) >= 0 &&
                (t = top) - (b = base) > 0) {
                int mask = size - 1;
                do { // emulate poll from old array, push to new array
                    java.util.concurrency.ForkJoinTask<?> x;
                    int oldj = ((b & oldMask) << ASHIFT) + ABASE;
                    int j    = ((b &    mask) << ASHIFT) + ABASE;
                    x = (java.util.concurrency.ForkJoinTask<?>)U.getObjectVolatile(oldA, oldj);
                    if (x != null &&
         ...
         */
        final java.util.concurrency.ForkJoinTask<?> pop() {
            java.util.concurrency.ForkJoinTask<?>[] a; java.util.concurrency.ForkJoinTask<?> t; int m;
            if ((a = array) != null && (m = a.length - 1) >= 0) {
                for (int s; (s = top - 1) - base >= 0;) {
                    long j = ((m & s) << ASHIFT) + ABASE;
                    if ((t = (java.util.concurrency.ForkJoinTask<?>)U.getObject(a, j)) == null)
                        break;
         ...
         */
        final java.util.concurrency.ForkJoinTask<?> pollAt(int b) {
            java.util.concurrency.ForkJoinTask<?> t; java.util.concurrency.ForkJoinTask<?>[] a;
            if ((a = array) != null) {
                int j = (((a.length - 1) & b) << ASHIFT) + ABASE;
                if ((t = (java.util.concurrency.ForkJoinTask<?>)U.getObjectVolatile(a, j)) != null &&
         ...
         */
        final java.util.concurrency.ForkJoinTask<?> poll() {
            java.util.concurrency.ForkJoinTask<?>[] a; int b; java.util.concurrency.ForkJoinTask<?> t;
            while ((b = base) - top < 0 && (a = array) != null) {
                int j = (((a.length - 1) & b) << ASHIFT) + ABASE;
                t = (java.util.concurrency.ForkJoinTask<?>)U.getObjectVolatile(a, j);
                if (base == b) {
                    if (t != null) {
                        if (U.compareAndSwapObject(a, j, t, null)) {
                            base = b + 1;
         ...
         */
        final java.util.concurrency.ForkJoinTask<?> nextLocalTask() {
         ...
         */
        final java.util.concurrency.ForkJoinTask<?> peek() {
            java.util.concurrency.ForkJoinTask<?>[] a = array; int m;
            if (a == null || (m = a.length - 1) < 0)
                return null;
            int i = (config & FIFO_QUEUE) == 0 ? top - 1 : base;
            int j = ((i & m) << ASHIFT) + ABASE;
            return (java.util.concurrency.ForkJoinTask<?>)U.getObjectVolatile(a, j);
        }
        ...
        */
        final boolean tryUnpush(java.util.concurrency.ForkJoinTask<?> t) {
            java.util.concurrency.ForkJoinTask<?>[] a; int s;
        ...
        final void cancelAll() {
            java.util.concurrency.ForkJoinTask<?> t;
            if ((t = currentJoin) != null) {
                currentJoin = null;
                java.util.concurrency.ForkJoinTask.cancelIgnoringExceptions(t);
            }
        ...
        final void pollAndExecAll() {
            for (java.util.concurrency.ForkJoinTask<?> t; (t = poll()) != null;)
                t.doExec();
        }
        ...
        final void execLocalTasks() {
            int b = base, m, s;
            java.util.concurrency.ForkJoinTask<?>[] a = array;
            if (b - (s = top - 1) <= 0 && a != null &&
                (m = a.length - 1) >= 0) {
                if ((config & FIFO_QUEUE) == 0) {
                    for (java.util.concurrency.ForkJoinTask<?> t;;) {
                        if ((t = (java.util.concurrency.ForkJoinTask<?>)U.getAndSetObject
         ...
         */
        final void runTask(java.util.concurrency.ForkJoinTask<?> task) {
            if (task != null) {
                scanState &= ~SCANNING; // mark as busy
                (currentSteal = task).doExec();
                U.putOrderedObject(this, QCURRENTSTEAL, null); // release for GC
                execLocalTasks();
                java.util.concurrency.ForkJoinWorkerThread thread = owner;
         ...
         */
        final boolean tryRemoveAndExec(java.util.concurrency.ForkJoinTask<?> task) {
            java.util.concurrency.ForkJoinTask<?>[] a; int m, s, b, n;
            if ((a = array) != null && (m = a.length - 1) >= 0 &&
                task != null) {
                while ((n = (s = top) - (b = base)) > 0) {
                    for (java.util.concurrency.ForkJoinTask<?> t;;) {      // traverse from s to b
        ...
        final CountedCompleter<?> popCC(CountedCompleter<?> task, int mode) {
            int s; java.util.concurrency.ForkJoinTask<?>[] a; Object o;
        ...
        final int pollAndExecCC(CountedCompleter<?> task) {
            int b, h; java.util.concurrency.ForkJoinTask<?>[] a; Object o;
        ...
        static {
            try {
                ...
                Class<?> ak = java.util.concurrency.ForkJoinTask[].class;
    ...
    private int awaitRunStateLock() {
        ...
        for (int spins = SPINS, r = 0, rs, ns;;) {
            if (((rs = runState) & RSLOCK) == 0) {
                ...
                r = java.util.concurrency.ThreadLocalRandom.nextSecondarySeed();
            else if (spins > 0) {
                    ...
                    if ((runState & RSIGNAL) != 0) {
                        try {
                            ...
                            if (!(Thread.currentThread() instanceof
                                    java.util.concurrency.ForkJoinWorkerThread))
                                wasInterrupted = true;
                        }
                    }
                    else
    ...
    private boolean createWorker() {
        ...
        Throwable ex = null;
        java.util.concurrency.ForkJoinWorkerThread wt = null;
        try {
     ...
     */
    final WorkQueue registerWorker(java.util.concurrency.ForkJoinWorkerThread wt) {
     ...
     */
    final void deregisterWorker(java.util.concurrency.ForkJoinWorkerThread wt, Throwable ex) {
        WorkQueue w = null;
        ...
        if (ex == null)                               // help clean on way out
            java.util.concurrency.ForkJoinTask.helpExpungeStaleExceptions();
        else                                          // rethrow
            java.util.concurrency.ForkJoinTask.rethrow(ex);
    }
     ...
     */
    private java.util.concurrency.ForkJoinTask<?> scan(WorkQueue w, int r) {
        WorkQueue[] ws; int m;
        if ((ws = workQueues) != null && (m = ws.length - 1) > 0 && w != null) {
            int ss = w.scanState;                     // initially non-negative
            for (int origin = r & m, k = origin, oldSum = 0, checkSum = 0;;) {
                WorkQueue q; java.util.concurrency.ForkJoinTask<?>[] a; java.util.concurrency.ForkJoinTask<?> t;
                int b, n; long c;
                if ((q = ws[k]) != null) {
                    if ((n = (b = q.base) - q.top) < 0 &&
                        (a = q.array) != null) {      // non-empty
                        long i = (((a.length - 1) & b) << ASHIFT) + ABASE;
                        if ((t = ((java.util.concurrency.ForkJoinTask<?>)
     ...
     */
    private void helpStealer(WorkQueue w, java.util.concurrency.ForkJoinTask<?> task) {
        ...
        if (ws != null && (m = ws.length - 1) >= 0 && w != null &&
            ...
            do {                                       // restart point
                ...
                java.util.concurrency.ForkJoinTask<?> subtask;
                ...
                descent: for (subtask = task; subtask.status >= 0; ) {
                    ...
                    for (;;) {                         // help v or descend
                        java.util.concurrency.ForkJoinTask<?>[] a; int b;
                        checkSum += (b = v.base);
                        java.util.concurrency.ForkJoinTask<?> next = v.currentJoin;
                        ...
                        java.util.concurrency.ForkJoinTask<?> t = ((java.util.concurrency.ForkJoinTask<?>)
                        ...
                        if (v.base == b) {
                            ...
                            if (U.compareAndSwapObject(a, i, t, null)) {
                                v.base = b + 1;
                                java.util.concurrency.ForkJoinTask<?> ps = w.currentSteal;
                                int top = w.top;
                                do {
    ...
    private boolean tryCompensate(WorkQueue w) {
        ...
        if (w == null || w.qlock < 0 ||           // caller terminating
            ...
            if (nbusy != (tc << 1) || ctl != c)
                ...
                throw new java.util.concurrency.RejectedExecutionException(
     ...
     * @return task status on exit
     */
    final int awaitJoin(WorkQueue w, java.util.concurrency.ForkJoinTask<?> task, long deadline) {
        int s = 0;
        if (task != null && w != null) {
            java.util.concurrency.ForkJoinTask<?> prevJoin = w.currentJoin;
            ...
            for (;;) {
                ...
                if (deadline == 0L)
                    ...
                    break;
                else if ((ms = java.util.concurrency.TimeUnit.NANOSECONDS.toMillis(ns)) <= 0L)
                    ms = 1L;
                if (tryCompensate(w)) {
    ...
    private WorkQueue findNonEmptyStealQueue() {
        ...
        int r = java.util.concurrency.ThreadLocalRandom.nextSecondarySeed();
        if ((ws = workQueues) != null && (m = ws.length - 1) >= 0) {
            for (int origin = r & m, k = origin, oldSum = 0, checkSum = 0;;) {
                WorkQueue q; int b;
                if ((q = ws[k]) != null) {
    ...
    final void helpQuiescePool(WorkQueue w) {
        java.util.concurrency.ForkJoinTask<?> ps = w.currentSteal; // save context
        for (boolean active = true;;) {
            long c; WorkQueue q; java.util.concurrency.ForkJoinTask<?> t; int b;
     ...
     */
    final java.util.concurrency.ForkJoinTask<?> nextTaskFor(WorkQueue w) {
        for (java.util.concurrency.ForkJoinTask<?> t;;) {
            WorkQueue q; int b;
    ...
    static int getSurplusQueuedTaskCount() {
        Thread t; java.util.concurrency.ForkJoinWorkerThread wt; ForkJoinPool pool; WorkQueue q;
        if (((t = Thread.currentThread()) instanceof java.util.concurrency.ForkJoinWorkerThread)) {
            int p = (pool = (wt = (java.util.concurrency.ForkJoinWorkerThread)t).pool).
                config & SMASK;
    ...
    private boolean tryTerminate(boolean now, boolean enable) {
        ...
        for (long oldSum = 0L;;) {                // or until done or stable
            WorkQueue[] ws; WorkQueue w; java.util.concurrency.ForkJoinWorkerThread wt; int m;
            long checkSum = ctl;
     ...
     * @param task the task. Caller must ensure non-null.
     */
    private void externalSubmit(java.util.concurrency.ForkJoinTask<?> task) {
        int r;                                    // initialize caller's probe
        if ((r = java.util.concurrency.ThreadLocalRandom.getProbe()) == 0) {
            java.util.concurrency.ThreadLocalRandom.localInit();
            r = java.util.concurrency.ThreadLocalRandom.getProbe();
        }
        for (;;) {
            ...
            if ((rs = runState) < 0) {
                ...
                if (q.qlock == 0 && U.compareAndSwapInt(q, QLOCK, 0, 1)) {
                    java.util.concurrency.ForkJoinTask<?>[] a = q.array;
                    int s = q.top;
            ...
            if (move)
                r = java.util.concurrency.ThreadLocalRandom.advanceProbe(r);
        }
    }
     ...
     * @param task the task. Caller must ensure non-null.
     */
    final void externalPush(java.util.concurrency.ForkJoinTask<?> task) {
        WorkQueue[] ws; WorkQueue q; int m;
        int r = java.util.concurrency.ThreadLocalRandom.getProbe();
        int rs = runState;
        if ((ws = workQueues) != null && (m = (ws.length - 1)) >= 0 &&
            (q = ws[m & r & SQMASK]) != null && r != 0 && rs > 0 &&
            U.compareAndSwapInt(q, QLOCK, 0, 1)) {
            java.util.concurrency.ForkJoinTask<?>[] a; int am, n, s;
            if ((a = q.array) != null &&
     ...
     */
    final boolean tryExternalUnpush(java.util.concurrency.ForkJoinTask<?> task) {
        WorkQueue[] ws; WorkQueue w; java.util.concurrency.ForkJoinTask<?>[] a; int m, s;
        int r = java.util.concurrency.ThreadLocalRandom.getProbe();
        if ((ws = workQueues) != null && (m = ws.length - 1) >= 0 &&
     ...
     * @throws java.util.concurrency.RejectedExecutionException if the task cannot be
     *         scheduled for execution
     */
    public <T> T invoke(java.util.concurrency.ForkJoinTask<T> task) {
        if (task == null)
            throw new NullPointerException();
        externalPush(task);
        return task.join();
     ...
     *         scheduled for execution
     */
    public void execute(java.util.concurrency.ForkJoinTask<?> task) {
        if (task == null)
            throw new NullPointerException();
        externalPush(task);
    }
    ...
    public void execute(Runnable task) {
        if (task == null)
            throw new NullPointerException();
        java.util.concurrency.ForkJoinTask<?> job;
        if (task instanceof java.util.concurrency.ForkJoinTask<?>) // avoid re-wrap
            job = (java.util.concurrency.ForkJoinTask<?>) task;
        else
            job = new java.util.concurrency.ForkJoinTask.RunnableExecuteAction(task);
        externalPush(job);
    }
     ...
     *         scheduled for execution
     */
    public <T> java.util.concurrency.ForkJoinTask<T> submit(java.util.concurrency.ForkJoinTask<T> task) {
        if (task == null)
            throw new NullPointerException();
        externalPush(task);
        return task;
     ...
     *         scheduled for execution
     */
    public <T> java.util.concurrency.ForkJoinTask<T> submit(java.util.concurrency.Callable<T> task) {
        java.util.concurrency.ForkJoinTask<T> job = new java.util.concurrency.ForkJoinTask.AdaptedCallable<T>(task);
        externalPush(job);
        return job;
    }
     ...
     *         scheduled for execution
     */
    public <T> java.util.concurrency.ForkJoinTask<T> submit(Runnable task, T result) {
        java.util.concurrency.ForkJoinTask<T> job = new java.util.concurrency.ForkJoinTask.AdaptedRunnable<T>(task, result);
        externalPush(job);
        return job;
    }
     ...
     *         scheduled for execution
     */
    public java.util.concurrency.ForkJoinTask<?> submit(Runnable task) {
        if (task == null)
            throw new NullPointerException();
        java.util.concurrency.ForkJoinTask<?> job;
        if (task instanceof java.util.concurrency.ForkJoinTask<?>) // avoid re-wrap
            ...
            job = new java.util.concurrency.ForkJoinTask.AdaptedRunnableAction(task);
        externalPush(job);
        return job;
    }
     ...
     * @throws java.util.concurrency.RejectedExecutionException {@inheritDoc}
     */
    public <T> List<java.util.concurrency.Future<T>> invokeAll(Collection<? extends java.util.concurrency.Callable<T>> tasks) {
        // In previous versions of this class, this method constructed
        // a task to run ForkJoinTask.invokeAll, but now external
        // invocation of multiple tasks is at least as efficient.
        ArrayList<java.util.concurrency.Future<T>> futures = new ArrayList<>(tasks.size());

        boolean done = false;
        try {
            for (java.util.concurrency.Callable<T> t : tasks) {
                java.util.concurrency.ForkJoinTask<T> f = new java.util.concurrency.ForkJoinTask.AdaptedCallable<T>(t);
                futures.add(f);
                externalPush(f);
            }
            for (int i = 0, size = futures.size(); i < size; i++)
                ((java.util.concurrency.ForkJoinTask<?>)futures.get(i)).quietlyJoin();
            done = true;
            return futures;
        } finally {
            if (!done)
     ...
     */
    protected java.util.concurrency.ForkJoinTask<?> pollSubmission() {
        WorkQueue[] ws; WorkQueue w; java.util.concurrency.ForkJoinTask<?> t;
        if ((ws = workQueues) != null) {
            for (int i = 0; i < ws.length; i += 2) {
     ...
     */
    protected int drainTasksTo(Collection<? super java.util.concurrency.ForkJoinTask<?>> c) {
        int count = 0;
        WorkQueue[] ws; WorkQueue w; java.util.concurrency.ForkJoinTask<?> t;
        if ((ws = workQueues) != null) {
     ...
     * advisory notes for class {@link java.util.concurrency.ForkJoinTask} stating that
     ...
     * #awaitQuiescence(long, java.util.concurrency.TimeUnit)} but always returns {@code false}.
     *
     ...
     */
    public boolean awaitTermination(long timeout, java.util.concurrency.TimeUnit unit)
        ...
        synchronized (this) {
            for (;;) {
                ...
                if (nanos <= 0L)
                    return false;
                long millis = java.util.concurrency.TimeUnit.NANOSECONDS.toMillis(nanos);
     ...
     * in effect to {@link java.util.concurrency.ForkJoinTask#helpQuiesce}. Otherwise,
     ...
     * timeout elapsed.
     */
    public boolean awaitQuiescence(long timeout, java.util.concurrency.TimeUnit unit) {
        long nanos = unit.toNanos(timeout);
        java.util.concurrency.ForkJoinWorkerThread wt;
        Thread thread = Thread.currentThread();
        if ((thread instanceof java.util.concurrency.ForkJoinWorkerThread) &&
            (wt = (java.util.concurrency.ForkJoinWorkerThread)thread).pool == this) {
        ...
        while (!isQuiescent() && (ws = workQueues) != null &&
            ...
            for (int j = (m + 1) << 2; j >= 0; --j) {
                java.util.concurrency.ForkJoinTask<?> t; WorkQueue q; int b, k;
    ...
    static void quiesceCommonPool() {
        common.awaitQuiescence(Long.MAX_VALUE, java.util.concurrency.TimeUnit.NANOSECONDS);
    }
     ...
     * java.util.concurrency.ForkJoinTask#inForkJoinPool() running in a ForkJoinPool}, this
    ...
    public static void managedBlock(ManagedBlocker blocker)
        ...
        if ((t instanceof java.util.concurrency.ForkJoinWorkerThread) &&
            (p = (wt = (java.util.concurrency.ForkJoinWorkerThread)t).pool) != null) {
    ...
    protected <T> java.util.concurrency.RunnableFuture<T> newTaskFor(Runnable runnable, T value) {
        return new java.util.concurrency.ForkJoinTask.AdaptedRunnable<T>(runnable, value);
    }

    protected <T> java.util.concurrency.RunnableFuture<T> newTaskFor(java.util.concurrency.Callable<T> callable) {
        return new java.util.concurrency.ForkJoinTask.AdaptedCallable<T>(callable);
    }
    ...
    private static ForkJoinPool makeCommonPool() {
        ...
        try {  // ignore exceptions in accessing/parsing properties
            ...
            String fp = System.getProperty
                ("ForkJoinPool.common.threadFactory");
            String hp = System.getProperty
                ("ForkJoinPool.common.exceptionHandler");
            if (pp != null)
    ...
    static final class InnocuousForkJoinWorkerThreadFactory
        ...
        public final java.util.concurrency.ForkJoinWorkerThread newThread(ForkJoinPool pool) {
            return (java.util.concurrency.ForkJoinWorkerThread.InnocuousForkJoinWorkerThread)
                java.security.AccessController.doPrivileged(
                    new java.security.PrivilegedAction<java.util.concurrency.ForkJoinWorkerThread>() {
                    public java.util.concurrency.ForkJoinWorkerThread run() {
