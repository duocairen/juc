...
import java.util.concurrency.atomic.LongAdder;
 ...
 * java.util.concurrency.ForkJoinPool#commonPool()} that is used for all parallel
...
public class ConcurrentHashMap<K,V> extends AbstractMap<K,V>
    implements java.util.concurrency.ConcurrentMap<K,V>, Serializable {
    ...
    final int batchFor(long b) {
        ...
        if (b == Long.MAX_VALUE || (n = sumCount()) <= 1L || n < b)
            return 0;
        int sp = java.util.concurrency.ForkJoinPool.getCommonPoolParallelism() << 2; // slack of 4
    ...
    abstract static class BulkTask<K,V,R> extends java.util.concurrency.CountedCompleter<R> {
    ...
    static final class ReduceKeysTask<K,V>
        ...
        public final void compute() {
            ...
            if ((reducer = this.reducer) != null) {
                ...
                result = r;
                java.util.concurrency.CountedCompleter<?> c;
