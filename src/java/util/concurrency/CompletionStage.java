 ...
 * or custom (via a supplied {@link java.util.concurrency.Executor}).  The execution
...
public interface CompletionStage<T> {
    ...
    /**
     * Returns a {@link java.util.concurrency.CompletableFuture} maintaining the same
     ...
     */
    public java.util.concurrency.CompletableFuture<T> toCompletableFuture();
