...
/**
 * A scalable concurrent {@link java.util.concurrency.ConcurrentNavigableMap} implementation.
...
public class ConcurrentSkipListMap<K,V> extends AbstractMap<K,V>
    implements java.util.concurrency.ConcurrentNavigableMap<K,V>, Cloneable, Serializable {
    /*
    ...
    private transient java.util.concurrency.ConcurrentNavigableMap<K,V> descendingMap;
    ...
    public java.util.concurrency.ConcurrentNavigableMap<K,V> descendingMap() {
        java.util.concurrency.ConcurrentNavigableMap<K,V> dm = descendingMap;
     ...
     */
    public java.util.concurrency.ConcurrentNavigableMap<K,V> subMap(K fromKey,
     ...
     * @throws IllegalArgumentException {@inheritDoc}
     */
    public java.util.concurrency.ConcurrentNavigableMap<K,V> headMap(K toKey,
                                                                     boolean inclusive) {
        if (toKey == null)
            throw new NullPointerException();
        return new SubMap<K,V>
     ...
     * @throws IllegalArgumentException {@inheritDoc}
     */
    public java.util.concurrency.ConcurrentNavigableMap<K,V> tailMap(K fromKey,
                                                                     boolean inclusive) {
        if (fromKey == null)
            throw new NullPointerException();
        return new SubMap<K,V>
     ...
     * @throws IllegalArgumentException {@inheritDoc}
     */
    public java.util.concurrency.ConcurrentNavigableMap<K,V> subMap(K fromKey, K toKey) {
    ...
    static final class KeySet<E>
        ...
        final java.util.concurrency.ConcurrentNavigableMap<E,?> m;
        KeySet(java.util.concurrency.ConcurrentNavigableMap<E,?> map) { m = map; }
    ...
    static final class Values<E> extends AbstractCollection<E> {
        final java.util.concurrency.ConcurrentNavigableMap<?, E> m;
        Values(java.util.concurrency.ConcurrentNavigableMap<?, E> map) {
            m = map;
        }
        @SuppressWarnings("unchecked")
        public Iterator<E> iterator() {
    ...
    static final class EntrySet<K1,V1> extends AbstractSet<Entry<K1,V1>> {
        final java.util.concurrency.ConcurrentNavigableMap<K1, V1> m;
        EntrySet(java.util.concurrency.ConcurrentNavigableMap<K1, V1> map) {
            m = map;
        }
        @SuppressWarnings("unchecked")
